...
namespace Notes.Models
{
	...
	public class EditNoteDto : CreateNoteDto
	{
		...
		[Remote(action: "VerifyIfNoteAlreadyExist", controller: "Notes", AdditionalFields = nameof(Id))] //To verify real-time from the front end if a note with this text already exists
